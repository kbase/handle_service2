...
public class AbstractHandleClient {
    ...
    static {
        try {
            DEFAULT_URL = new URL("https://ci.kbase.us/services/handle_service");
     ...
     * validity.
     */
    public AbstractHandleClient(AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public AbstractHandleClient(String user, String password) throws UnauthorizedException, IOException {
