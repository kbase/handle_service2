...
class ConfigTest(unittest.TestCase):
    ...
    def test_minimal_config(self):
        ...
        try:
            ...
            default_path = os.environ[mango_util.TEST_CONFIG_ENV_PATH]
            os.environ[mango_util.TEST_CONFIG_ENV_PATH] = cfg_path
            mongo_cfg, deploy_cfg = mongo_util.get_config()
        finally:
            os.environ[mango_util.TEST_CONFIG_ENV_PATH] = default_path
        ...
        # check deploy config
        self.assertEqual(deploy_cfg["auth-service-url"], 'https://ci.kbase.us/services/auth/api/legacy/KBase/Sessions/Login')
        self.assertEqual(deploy_cfg["auth-url"], 'https://ci.kbase.us/services/auth')
        self.assertEqual(deploy_cfg["shock-url"], 'https://ci.kbase.us/services/shock-api')
